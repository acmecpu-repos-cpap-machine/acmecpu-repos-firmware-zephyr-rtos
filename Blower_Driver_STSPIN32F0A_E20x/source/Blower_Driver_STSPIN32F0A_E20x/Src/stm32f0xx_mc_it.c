...
void USART_IRQHandler(void)
{
  /* USER CODE BEGIN USART_IRQn 0 */
	if (LL_USART_IsActiveFlag_RXNE(USART1) && LL_USART_IsEnabledIT_RXNE(USART1)) { /* Valid data have been received */
		uart_m2m_comm_rx_handler();
	}
	...
	if (LL_USART_IsActiveFlag_ORE(USART1)) { /* Overrun error occurs */
		/* TODO Call overrun function */
