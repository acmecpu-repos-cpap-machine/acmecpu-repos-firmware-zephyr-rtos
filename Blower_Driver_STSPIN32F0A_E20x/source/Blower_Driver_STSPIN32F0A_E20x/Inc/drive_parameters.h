...
#define MAX_APPLICATION_SPEED_RPM       55000 /*!< rpm, mechanical */
#define MIN_APPLICATION_SPEED_RPM       0 /*!< rpm, mechanical,
                                                           absolute value */
#define MEAS_ERRORS_BEFORE_FAULTS       12 /*!< Number of speed
...
#define PLL_KP_GAIN                      4180
#define PLL_KI_GAIN                      211
#define PLL_KPDIV     16384
#define PLL_KPDIV_LOG LOG2(PLL_KPDIV)
#define PLL_KIDIV     65535
#define PLL_KIDIV_LOG LOG2(PLL_KIDIV)

#define OBS_MEAS_ERRORS_BEFORE_FAULTS    12  /*!< Number of consecutive errors
...
#define PID_TORQUE_KP_DEFAULT         1843
#define PID_TORQUE_KI_DEFAULT         1881
#define PID_TORQUE_KD_DEFAULT         100
#define PID_FLUX_KP_DEFAULT           1843
#define PID_FLUX_KI_DEFAULT           1881
...
#define PID_SPEED_KP_DEFAULT          3155/(SPEED_UNIT/10) /* Workbench compute the gain for 01Hz unit*/
#define PID_SPEED_KI_DEFAULT          3230/(SPEED_UNIT/10) /* Workbench compute the gain for 01Hz unit*/
...
#define DEFAULT_CONTROL_MODE           STC_SPEED_MODE /*!< STC_TORQUE_MODE or
                                                        STC_SPEED_MODE */
#define DEFAULT_TARGET_SPEED_RPM      10000
...
#define PHASE1_FINAL_CURRENT           6116
/* Phase 2 */
#define PHASE2_DURATION                3000 /*milliseconds */
#define PHASE2_FINAL_SPEED_UNIT         (10000*SPEED_UNIT/_RPM)
#define PHASE2_FINAL_CURRENT           6116
/* Phase 3 */
#define PHASE3_DURATION                0 /*milliseconds */
#define PHASE3_FINAL_SPEED_UNIT         (10000*SPEED_UNIT/_RPM)
#define PHASE3_FINAL_CURRENT           6116
/* Phase 4 */
#define PHASE4_DURATION                0 /*milliseconds */
#define PHASE4_FINAL_SPEED_UNIT         (10000*SPEED_UNIT/_RPM)
#define PHASE4_FINAL_CURRENT           6116
/* Phase 5 */
#define PHASE5_DURATION                0 /* milliseconds */
#define PHASE5_FINAL_SPEED_UNIT         (10000*SPEED_UNIT/_RPM)
#define PHASE5_FINAL_CURRENT           6116

#define ENABLE_SL_ALGO_FROM_PHASE      1
/* Sensor-less rev-up sequence */
#define STARTING_ANGLE_DEG             90  /*!< degrees [0...359] */
/* Observer start-up output conditions  */
#define OBS_MINIMUM_SPEED_RPM          9000
