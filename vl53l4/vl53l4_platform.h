/* vl53l4_platform.h - Zephyr customization of ST vl53l4x library. */
...
#ifndef ZEPHYR_DRIVERS_SENSOR_VL53L4X_VL53L4_PLATFORM_H_
#define ZEPHYR_DRIVERS_SENSOR_VL53L4X_VL53L4_PLATFORM_H_

#include <string.h>
#include "vl53l4_ll_def.h"
#include "vl53l4_platform_log.h"
#include "vl53l4_platform_user_data.h"
 ...
 * @return VL53L4_ERROR_NONE  Success
 * @return "Other error code" See ::VL53L4_Error
 */
VL53L4_Error VL53L4_WriteMulti(VL53L4_Dev_t *pdev, uint16_t index,
 ...
 * @return "Other error code" See ::VL53L4_Error
 */
VL53L4_Error VL53L4_ReadMulti(VL53L4_Dev_t *pdev, uint16_t index,
		uint8_t *pdata, uint32_t count);
 ...
 * @return "Other error code" See ::VL53L4_Error
 */
VL53L4_Error VL53L4_WrByte(VL53L4_Dev_t *pdev, uint16_t index, uint8_t data);
 ...
 * @return "Other error code" See ::VL53L4_Error
 */
VL53L4_Error VL53L4_WrWord(VL53L4_Dev_t *pdev, uint16_t index, uint16_t data);
 ...
 * @return "Other error code" See ::VL53L4_Error
 */
VL53L4_Error VL53L4_WrDWord(VL53L4_Dev_t *pdev, uint16_t index, uint32_t data);
 ...
 * @return "Other error code" See ::VL53L4_Error
 */
VL53L4_Error VL53L4_RdByte(VL53L4_Dev_t *pdev, uint16_t index, uint8_t *pdata);
 ...
 * @return "Other error code" See ::VL53L4_Error
 */
VL53L4_Error VL53L4_RdWord(VL53L4_Dev_t *pdev, uint16_t index, uint16_t *pdata);
 ...
 * @return "Other error code" See ::VL53L4_Error
 */
VL53L4_Error VL53L4_RdDWord(VL53L4_Dev_t *pdev, uint16_t index, uint32_t *pdata);
 ...
 * @return "Other error code" See ::VL53L4_Error
 */
VL53L4_Error VL53L4_GetTickCount(uint32_t *ptime_ms);
