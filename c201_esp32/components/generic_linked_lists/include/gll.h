...
#ifndef COMPONENTS_GENERIC_LINKED_LISTS_INCLUDE_GLL_H_
#define COMPONENTS_GENERIC_LINKED_LISTS_INCLUDE_GLL_H_
/*
...
#endif /* COMPONENTS_GENERIC_LINKED_LISTS_INCLUDE_GLL_H_ */
