...
#ifndef LIB_M2M_FRAME_H_
#define LIB_M2M_FRAME_H_

#define UART_M2M_FRAME_SIZE_MAX			CONFIG_LIB_M2M_FRAME_BUFFER_SIZE_MAX
...
#define UART_M2M_SOF_BYTE_1				0x53
#define UART_M2M_SOF_BYTE_2				0xAC

#define UART_M2M_ACK_TIMEOUT_BASE_MS	CONFIG_LIB_M2M_FRAME_ACK_TIMEOUT_MS
#define UART_M2M_RETRY_COUNT_MAX		CONFIG_LIB_M2M_FRAME_RETRY_COUNT_MAX
...
typedef enum {
	...
	UART_M2M_FRAME_DATA_RESP_ENDSTR,	/* TODO remove*/
 ...
 * @param verify_cksum[in]	Set to CHECKSUM_IGNORE if checksum verification needs to be ignored
 * 							Set to CHECKSUM_VERIFY if checksum verification needs to be performed
 * 							Useful if peer device does not support checksum computation
 * @return
 ...
 * 			This function calls lib_m2m_frame_serialize() internally.
